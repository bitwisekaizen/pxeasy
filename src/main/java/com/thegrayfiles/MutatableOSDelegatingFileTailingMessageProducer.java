 ...
 *
 */
public class MutatableOSDelegatingFileTailingMessageProducer extends FileTailingMessageProducerSupport
    ...
    private void startProcessMonitor() {
        this.getTaskExecutor().execute(new Runnable() {
            ...
            @Override
            public void run() {
                Process process = MutatableOSDelegatingFileTailingMessageProducer.this.process;
                if (process == null) {
